...
?> 
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" placeholder="<?php echo $productname; ?>" required="required" name="pname">
    </div>
     <div class="form-group col-md-6">
           <label for="inputState">Product Description</label>
      <input type="text" class="form-control" placeholder="<?php echo $desc; ?>"  required="required" name="description">
    </div>
   <div class="form-group col-md-6">
   ...
   <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" placeholder="<?php echo $size; ?>"  required="required" name="sizes">
    </div>
     <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" placeholder="<?php echo $price; ?>"  required="required" name="price">
    </div>
    <div class="form-group col-md-6">
           <label for="inputState">Delivery Area</label>
      <input type="text" class="form-control" placeholder="<?php echo $area; ?>"  required="required" name="area">
    </div>
    
    <div class="form-group col-md-6">
           <label for="inputState">In exchange</label>
      <input type="text" class="form-control" placeholder="<?php echo $exchange; ?>"  required="required" name="inexchange">
    </div>
