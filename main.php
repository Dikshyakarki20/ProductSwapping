...
$image= $row["image"];
        echo "<div class='hero-carousel__slide'>
          ...
          <a href='clothing.php' class='hero-carousel__slideOverlay'>
            <h3>$productname</h3>
            <p>$category</p>
          </a>
        </div>";
...
$image= $row["image"];
        echo "<div class='hero-carousel__slide'>
          <img src='uploads/$image' alt='' class='card-img'>
          <a href='electronics.php' class='hero-carousel__slideOverlay'>
            <h3>$productname</h3>
            <p>$category</p>
          </a>
        </div>";
...
$image= $row["image"];
        echo "<div class='hero-carousel__slide'>
          <img src='uploads/$image' alt='' class='card-img'>
          <a href='auto.php' class='hero-carousel__slideOverlay'>
            <h3>$productname</h3>
            <p>$category</p>
          </a>
        </div>";
